...
->Types of Modules:
   1) File based module: which can transferred from one file to another
...
module.exports = b; // now it can be used in any file just import it there say insie app.js
module.exports=obj;
