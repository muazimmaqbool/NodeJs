...
// or http.createServer((request,response,next)=>{
  ...
  //thats 'response' nad next is callback function for now we don't need it its generally required
...
//hold and click on localhost:4000 in terminal it will open in browser
